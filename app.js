...
async function loadSoundFontLib() {
  ...
  const lib = await import("https://cdn.jsdelivr.net/npm/spessasynth_lib@4.3.22/+esm");
...
$("sf2").onchange = async e => {
  ...
  try {
    ...
    const workletURL = "https://cdn.jsdelivr.net/npm/spessasynth_lib@4.3.22/dist/spessasynth_processor.min.js";
