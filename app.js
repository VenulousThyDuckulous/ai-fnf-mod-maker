...
let SoundFont = null, Synthesizer = null;
...
async function loadSoundFontLib() {
  if (SoundFont && Synthesizer) return;
  const mod = await import("https://cdn.jsdelivr.net/npm/spessasynth_lib@3.20.0/+esm");
  SoundFont = mod.SoundFont;
  Synthesizer = mod.Synthesizer;
}
